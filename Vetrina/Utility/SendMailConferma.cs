...
{
    public class SendMailConferma
    {
        public static string EmailDiConferma(string nome, string cognome, string email, string indirizzo, string città, string cap, string pagamento, List<DettaglioProdottiOrdine> prodotti, string nazione)
        {
            try
            {
                ...
                mail.To.Add(email);
                mail.Subject = $"PlexEvolution - Ordine Effettuato";
                ...
                foreach (var prodotto in prodotti)
                {
                    ...
                    string coloreNome = GetColoreNomeById((int)prodotto.id_colore);
                    string spessoreNome = GetSpessoreNomeById((int)prodotto.id_spessore);
                   ...
                   <body>
                    <div class='container'>
                        <div class='center bg-color'>
                            <img src='https://www.plexevolution.it/Resources/logo.png' style='margin: 0 auto; display: block;'/> 
                        </div>
