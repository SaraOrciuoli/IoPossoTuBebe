...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        updateCalendars: function () {
            ...
            this.container.find('.calendar.left').html(this.renderCalendar(this.leftCalendar.calendar, this.startDate, this.minDate, this.maxDate, 'Seleziona data inizio'));
            this.container.find('.calendar.right').html(this.renderCalendar(this.rightCalendar.calendar, this.endDate, this.startDate, this.maxDate, 'Seleziona data fine'));
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, label) {
            ...
            html += '<th class="month" colspan="5">' + label + '</th>';
